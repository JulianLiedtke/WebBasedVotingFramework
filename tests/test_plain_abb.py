"""
This module provides test cases for the plain (unencrypted) ABB.
"""
import logging
import time
import unittest
...
class PlainABBTest(unittest.TestCase):
    """
    This class provides test cases for the plain (unencrypted) ABB.
    """
    ...
    def test_correctness_without_randomness(self):
        """
        Tests the correctness of the encryption where no randomness is used.
        """
