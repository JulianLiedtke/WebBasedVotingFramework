...
class ElectionProperties(object):
    ...
    def __init__(self, candidates, ballot_format=None, start_date=None, due_date=None, title="", expected_votes_n=None, use_constituencies = False,
    ...
    def deserialize(cls, serialized):
        subclass = get_class_from_name(serialized["evaluation"]["type"], subclasses_recursive(ElectionProperties))
